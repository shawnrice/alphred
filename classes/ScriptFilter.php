...
class ScriptFilter {
	...
	/**
	 * Outputs the script filter in Alfred 2 XML
	 *
	 * @since 1.0.0
	 * @deprecated 1.1.0 use to_json() instead for Alfred 3
	 *
	 */
	public function to_xml() {
		// Log a deprecation warning.
		\Alphred\Log::deprecated( 'Alphred\ScriptFilter::to_xml', 'Alphred\ScriptFilter::to_json' );
		// Maybe add in an empty response
		$this->maybe_add_empty();
	...
	/**
	 * Outputs the script filter in Alfred 3 JSON
	 *
	 * @since 1.1.0
	 */
	...
	/**
	 * Adds in an empty declaration to a script filter to show some sort of result
	 *
	 * @since 1.1.0
	 */
	private function maybe_add_empty() {
